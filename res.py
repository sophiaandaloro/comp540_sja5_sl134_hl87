#This Original Python file is the inception-resnet-v2 file which generate the inception-resnet model. We
#modified this model in order to add Gaussian noise layer in the hidden layer to see if this could 
#increase the validation accuracy of the model

#See the original file on github:
...
def Gaussian_noise(x, rate = 0.02):
    """A Layer for adding Gaussian_noise
    # Arguments
        x: input tensor.
        rate: rate of the Gaussian noise
    # Returns
        Output tensor after applying Gaussian noise, the dimension of the output tensor
        should be excactly the same as the input tensor.
        """
    x = GaussianNoise(rate)(x)
    return x
...
def InceptionResNetV2(include_top=True,
    ...
    # Arguments
        ...
        Noise_rate: Gaussian_noise rate.
    # Returns
    ...
    # ADDING GAUSIAN LAYER HERE
#     x = Gaussian_noise(x, rate = Noise_rate)
